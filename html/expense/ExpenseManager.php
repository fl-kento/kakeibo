...
class ExpenseManager {
  ...
  public function addExpense() {
    ...
    if (empty($validator->error_message)) {
      $sql = 'INSERT INTO expense (expense_no, user_id, type_no, amount, date) VALUE (:number, :id, :type, :money, :date)';
      $params = [':number' => $latest_no['latest_no'], ':id' => $_SESSION['id'], ':type' => $_POST['kinds'], ':money' => $_POST['money'], ':date' => $_POST['date']];
